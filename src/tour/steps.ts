...
export const MAIN_TOUR_STEPS: TourStepDef[] = [
    ...
    },
    {
        ...
        text: `Enter the <strong>registration</strong> to find a specific livery, or use <strong>keywords</strong>.<div style="padding-top:8px"><video autoplay loop muted playsinline><source src="${import.meta.env.BASE_URL}guides/filterSection.webm" type="video/webm"></video></div>`,
        placement: "bottom",
        route: "/search",
    },
    {
        ...
        text: `Select from <strong>developer</strong>, <strong>aircraft</strong>, <strong>category</strong> and <strong>engines</strong>.<div style="padding-top:8px"><video autoplay loop muted playsinline><source src="${import.meta.env.BASE_URL}guides/filtering.webm" type="video/webm"></video></div>`,
        placement: "bottom",
        route: "/search",
    },
    {
    ...
    },
    {
        ...
        text: `When updates are available, the <strong>livery cards</strong> will show in this page. <strong>Check for updates</strong> by clicking the button in the top right corner.<div style="padding-top:8px"><video autoplay loop muted playsinline><source src="${import.meta.env.BASE_URL}guides/updatePage.webm" type="video/webm"></video></div>`,
        placement: "auto",
        route: "/downloads",
    },
    {
        ...
        text: `<img
               ...
               src="${import.meta.env.BASE_URL}guides/endTour.webp" alt="End of the tour">
