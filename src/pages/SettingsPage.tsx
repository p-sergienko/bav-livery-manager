        ...
        <section className={styles.page}>
            ...
            <div className={styles.form}>
                ...
                <div className={styles.updates}>
                    <div>
                        Currently you are running BAV Livery Manager V{APP_VERSION}
                    </div>
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
                <label className={styles.pathInput}>
                    ...
                    <div className={styles.inputRow}>
                        <input value={formState.msfs2020Path}
                               onChange={(e) => setFormState((prev) => ({ ...prev, msfs2020Path: e.target.value }))}/>
                ...
                <label className={styles.pathInput}>
                    ...
                    <div className={styles.inputRow}>
                        <input value={formState.msfs2024Path}
                               onChange={(e) => setFormState((prev) => ({ ...prev, msfs2024Path: e.target.value }))}/>
                        <button type="button" onClick={() => handleBrowse('msfs2024Path')}>
                            Browse
                        </button>
                    </div>
                </label>
                <p className={styles.description}>Note: if you don't use the community folder, you can change the path
                    to your custom community directory.</p>
                <div className={styles.formActions}>
                    <button type="submit" className={styles.submitButton}>
                        Save Settings
                    </button>
                    <button type="button" className={styles.detectButton} onClick={handleAutoDetect}
                            disabled={detecting}>
            ...
            <footer className={styles.footer}>
                <p className={styles.footerText}>
                    Created by <span className={styles.footerAuthor}>Pavel Sergienko</span>, inspired by <span
                    className={styles.footerAuthor}>Laurie Cooper</span>, made for <span
                    className={styles.footerAuthor}>BAV Community</span>
                </p>
